...
2. **Do we need a synthetic customer origin for proxy testing?** Probably yes for Test-step verification. Static HTML served from Lighthouse itself, or a real test domain CNAME'd to Zybit. Decide before week 4.
