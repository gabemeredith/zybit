...
zybit/
  ...
  src/lib/audit/fixPreview/   — Before/after fix-preview pipeline (audit-mode AI advisor, Browserless render, Gemini 2.5 Flash Image inpaint, three-tier ladder)
